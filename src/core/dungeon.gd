...
## spec: docs/specs/dungeon_and_turns.md, docs/specs/monsters_and_combat.md (dungeon.gd 역할).
...
func build() -> void:
	...
	if _player != null:
		...
		_player.configure(grid, result["start"], turn_manager, _combat)
